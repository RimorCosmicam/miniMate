 ...
 * it travels, so pulling it clears the side it was covering. Drawn on nothing rather than over a
 * fill, so what opens up between the halves is whatever is behind it.
 */
@Composable
fun DiagonalStripes(
    travel: Float,
