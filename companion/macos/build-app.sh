...
cp Sources/Resources/Mini.png "$contents/Resources/Mini.png"
cp Sources/Resources/mont_thin.ttf Sources/Resources/mont_black.ttf "$contents/Resources/"
...
test -f "$contents/Resources/mont_black.ttf"
...
test -f "$contents/Resources/Mini.png"
echo "$app_dir"
